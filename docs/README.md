...
| [sprints/sprint-34.md](sprints/sprint-34.md) | live | Post-GW3 — the model-accuracy scoreboard (its ≥2-archived-and-scored blocker cleared when GW3 was scored), 2026-27 added to the walk-forward backtest plus a narrow minutes-only blend scope (3 of 4 seasons, still not shippable), and Sprint 32 finished: last eight functions deployed, its verification gate run for the first time. Also records why the published backtest tables are no longer reproducible. |
