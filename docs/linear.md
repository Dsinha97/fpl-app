...
| — | Ownership-scaled price threshold — **shipped 2026-09-21** | M7 | Falls `3,577 + 31,870`/pct (R²=0.811, n=248); rises flat 378,000 (R²=0.022 — ownership irrelevant). The walk-forward gate on ranking/classification was MIXED; the window probe measuring the mechanism directly was not. Readings beyond ±300% fell 5→1; B.Fernandes −736%→−88.8%. Open: the rise *level* is a mean over 55 events, and the §2c gate should be re-run now its flat baseline has been corrected. See [sprints/sprint-38.md](sprints/sprint-38.md) §2c, §2e |
