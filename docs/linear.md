...
| — | Price threshold scales with ownership (~22k net transfers per 1% owned) — measured, not gated | M7 | No Linear issue yet. Flat `DEFAULT_FALL_THRESHOLD = 150_000` is off by ~5.6× for a 39%-owned player. Deliberately **not** shipped as a fitted default; gate it the way the classifier was gated. Evidence: [sprints/sprint-38.md](sprints/sprint-38.md) §2b |
